...
<!-- might want to expand this into an Agile protocol - item writing guidelines, write the item, qualitative interviews and modify items, qualitative validation, improve item writing guidelines, develop AIG   -->
...
<!-- this would enhance the paper, let's see if we have time to do it -->
...
<!-- below will go in a separate file, I will show you during our meeting -->
...
Arkowitz, H., Westra, H. A., Miller, W. R., & Rollnick, S. (Eds.). (2007).Motivational interviewing in the treatment of psychological problems. Guilford Press.
